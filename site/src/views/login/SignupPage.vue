<template>
  <div class="bg-orange-50 h-screen flex flex-col overflow-auto">
    ...
    <div class="bg-white sm:shadow p-5 w-full h-screen sm:w-2/3 md:w-96 sm:h-fit mx-auto">
      ...
      <button class="round-full-button">註冊</button>
